  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-order-module"], {
    ...
    function srcAppOrderOrderPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrderPage = /*#__PURE__*/function () {
        function OrderPage(activateRoute, router, orderService, alertService, navCtrl, bluetoothSerial, toastCtrl, alertCtrl) {
        ...
        _createClass(OrderPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.activateRoute.queryParams.subscribe(function (params) {
              if (params && params.saleItems) {
                _this.orders = JSON.parse(params.saleItems);
          ...
          value: function printOrder(i) {
            ...
            this.bluetoothSerial.write(this.dataSend).then(function (success) {
              _this2.showToast(success);

              _this2.navCtrl.navigateRoot('/sales');
            }, function (error) {
          ...
          value: function remove(k) {
            alert(k); //let index = this.orders.indexOf(k);
