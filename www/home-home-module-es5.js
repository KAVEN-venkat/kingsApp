(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modals_type_type_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../modals/type/type.page */
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(modalController, navCtrl, menu, itemService, alertService, env, orderService, customerService, loadingController) {
        ...
        _createClass(HomePage, [{
          ...
          value: function ngOnInit() {
            if (!localStorage.getItem('user_id')) {
              ...
              this.navCtrl.navigateRoot('/home'); //this.openModal();
            }
          ...
          key: "ordersTotal",
          value: function ordersTotal() {
            var _this2 = this;

            //this.presentLoading();
            this.orderService.totalOrder().subscribe(function (data) {
              //this.presentLoadingDismiss();
              if (data['status']) {
                _this2.total = data['ordersTotal'].total;
          ...
          value: function getUser() {
            ...
            this.customerService.customer(localStorage.getItem('user_id')).subscribe(function (data) {
              if (data['status']) {
                _this4.customer = data['customerDetails'];
                console.log(_this4.customer);
              } else {
