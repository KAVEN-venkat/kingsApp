...
/* harmony import */ var _sale_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sale.page */ "./src/app/sale/sale.page.ts");
...
/* harmony import */ var _sale_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sale-routing.module */ "./src/app/sale/sale-routing.module.ts");
...
/* harmony import */ var src_app_services_item_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/item.service */ "./src/app/services/item.service.ts");
...
/* harmony import */ var src_app_services_order_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/services/order.service */ "./src/app/services/order.service.ts");
...
let SalePage = class SalePage {
    constructor(modalController, navCtrl, menu, categoryService, orderService, alertService, router, env, actionSheetController, loadingController, alertController, itemService, formBuilder, bluetoothSerial, toastCtrl, customerService) {
    ...
    removeOrder(index, orderId, itemNumber) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
SalePage.propDecorators = {
    inputElementQty: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['qtyFocus',] }],
    inputElementFrom: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['fromFocus',] }],
    inputElementTo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['toFocus',] }]
};
SalePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-sale',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./sale.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sale/sale.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./sale.page.scss */ "./src/app/sale/sale.page.scss")).default]
    })
], SalePage);
...
//# sourceMappingURL=sale-sale-module-es2015.js.map